...
public class DepositClientsOnDateView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        depositClientsTable.setModel(new DefaultTableModel(
            new Object [][] {
    ...
    private void addOneDayButtonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_addOneDayButtonActionPerformed
